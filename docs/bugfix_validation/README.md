...
| T-11 Pause/resume + Optuna SQLite + disk logging | [T11_pause_resume_hardening.md](T11_pause_resume_hardening.md) ([investigation](T11_findings.md)) | APPROVED 2026-04-30 — A+B+D shipped on `fix/T11-pause-resume-hardening`. Cross-reviewed by Codex (4 HIGH + 3 MEDIUM) and Kimi K2.6 via opencode-go (2 MAJOR + 4 MINOR). All HIGH/MEDIUM/MAJOR fixed before merge. 260 regression tests pass. Closes T-12 simultaneously (disk logging unit). |
