...
> ## ▶ ACTIVE DIRECTION (2026-07-05) — T-31 Multi-Class SIMCA: **Phases A + B + C COMPLETE, all three multi-family-gated** on `feat/T31-multiclass-simca` (pushed, NOT merged). NEXT = Phase D (GUI + export) → merge-gate.
