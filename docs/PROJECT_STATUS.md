...
> ## T-17 MERGE-READY — PR #63 OPEN (do NOT auto-merge) — 2026-07-02 — Multi-target regression on `feat/T17-multitarget-regression`, tip `283bfce`. Pushed. **PR #63 → `main` open; awaiting user greenlight.**
