...
> ## ▶ ACTIVE DIRECTION (2026-07-04) — T-31 Multi-Class SIMCA: **Phase A COMPLETE + review-gate-hardened** on `feat/T31-multiclass-simca` (pushed, NOT merged).
...
> **NEXT: Phase B** (Wold modeling/discriminating-power varsel + diagnostic plots + supervised prefilter, novelty-gated) → Phase C (search + task-type wiring + real-data e2e) → Phase D (GUI + export). Do NOT merge until Phases B–D + merge-gate. Full detail: SESSION_LOG 2026-07-04.
>
> ---
>
