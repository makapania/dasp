"""
Intelligent ensemble methods for spectral prediction (v3).
...
Ported from Spectral Predict v1.
"""
...
class RegionAwareWeightedEnsemble(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, models, model_names=None, n_regions=5, cv=5, preprocessors=None):
        ...
        preprocessors : list of preprocessors, optional
            Individual preprocessor for each base model.
        """
        self.models = models
    ...
    def predict(self, X):
        ...
        # Use the average prediction to determine region
...
class MixtureOfExpertsEnsemble(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, models, model_names=None, n_regions=5, soft_gating=True, preprocessors=None):
        ...
        self.preprocessors = preprocessors
        self.expert_assignment_ = None
        self.expert_weights_ = None
        self.analyzer_ = RegionBasedAnalyzer(n_regions=n_regions)

    @property
    def weights_(self):
        """Alias for expert_weights_."""
    ...
    def fit(self, X, y):
        ...
        # Get cross-validated predictions from all models
        predictions = []
        for model in self.models:
